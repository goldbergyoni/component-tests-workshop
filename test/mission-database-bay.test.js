...
describe('Sensors test', () => {
  ...
  test('When adding a valid event, Response should contain id', async () => {
    // Arrange
    const eventToAdd = getSensorEvent();
  ...
  test('when an event is deleted, then its indeed not existing anymore', async () => {
    // Arrange
    const eventToAdd = getSensorEvent();
    const id = (await request(expressApp)
      .post('/sensor-events')
