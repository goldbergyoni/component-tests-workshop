...
describe('Sensors test', () => {
  ...
  test('When inserting a valid event, should insert into DB', async () => {
    // Arrange
    const eventToAdd = getSensorEvent();
    ...
    // Assert
    expect(getResponse.body).toMatchObject(eventToAdd); // NOTE: there're other fields such as createAt, etc.
  });
  ...
  test('When an internal unknown error occurs during request, Then get back 500 error', async () => {
    ...
    const validEventToAdd = getSensorEvent();
    sinon
